...
DOAJ_DIR = os.path.join(DATA_ROOT, 'sherpa')
SHERPA_DIR = os.path.join(DATA_ROOT, 'sherpa')
SHERPA_TMP = os.path.join(SHERPA_DIR, 'pickle')
...
os.makedirs(SHERPA_TMP, exist_ok=True)
